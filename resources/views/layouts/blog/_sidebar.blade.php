<div id="sidebar" class="col-md-3 mt50 animated" data-animation="fadeInRight" data-animation-delay="250">
                ...
                <div class="mt25 pr25 pl25 clearfix">
                    ...
                    @foreach($categories as $category)
                        <li class="active"><a href="{{route('blog.category',$category->id)}}">{{ $category->name }} <span class="badge badge-pasific pull-right">{{$category->posts()->published()->get()->count()}}</span></a>
                        </li> 
                    @endforeach                   
                    </ul>
